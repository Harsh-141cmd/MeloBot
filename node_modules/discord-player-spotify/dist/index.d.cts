...
declare class SpotifyAPI {
     ...
     */
    static getEmbedLink(url: string, type: "track" | "playlist" | "album"): string;
    /**
     * Fetches and parses track/playlist/album info from the Spotify embed page.
     */
    static getTracksFromEmbed(url: string, type?: "track" | "playlist" | "album"): Promise<any | null>;
...
declare class SpotifyExtractor extends BaseExtractor<SpotifyExtractorInit> {
    static identifier: "com.discord-player.itsmaat.spotifyextractor";
    private _stream;
